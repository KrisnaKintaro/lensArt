    ...
    <script>
        $(document).ready(function() {
            ...
            $(".filter-menu button").on("click", function() {
                ...
                // Jika filter "semua" → tampilkan ulang seluruh item
                if (filter === "all") {
                    $(".gallery-item").show();
                    return;
                }
                    ...
                    $.each(data, function(i, item) {
                        ...
                        $("#gallery").append(`
                            <div class="col-sm-6 col-md-4 gallery-item" data-category="${item.idJenisLayanan}">
                                ...
                                <a 
                                    data-fancybox="gallery-${item.idJenisLayanan}"
                                    href="/assetslensart/portofolio/${item.urlPorto}"
                                    data-caption="${item.namaPortofolio}"
                                >
                                    <img 
                                        src="/assetslensart/portofolio/${item.urlPorto}"

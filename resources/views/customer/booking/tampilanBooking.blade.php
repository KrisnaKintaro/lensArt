    ...
    $(function() {
        ...
        var calendar = new FullCalendar.Calendar(wadahKalender, {
            ...
            select: function(info) {
                ...
                $('#divUploadBukti').hide(); // Sembunyikan container upload (karena select box kembali ke default)
                $('#fileBuktiBayar').val(''); // Pastikan input file kosong (opsional, karena reset() sudah handle ini)
                // ============================================================

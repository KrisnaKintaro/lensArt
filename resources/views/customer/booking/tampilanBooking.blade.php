...
@section('styles')
    ...
    <style>
        .swal2-container {
            z-index: 2060 !important; /* Bootstrap Modal itu 1055, jadi kita kasih 2000an biar menang */
        }
        ...
        /* Legend Warna */
        .day-low { background-color: #9dfca5ff !important; }
        .day-med { background-color: #fbec7cff !important; }
        .day-high {
        ...
        .day-high::after {
            ...
            color: #c62828;
            font-weight: bold; opacity: 0.5; font-size: 0.8rem;
        }
        .slot-booked {
        ...
        .booking-card {
            ...
            color: #333; /* Text jadi hitam biar kebaca di background putih */
...
<div class="modal fade" id="modalBooking" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content text-dark"> <div class="modal-header bg-primary text-white">
